    ...
    <div className='login-wrapper'>
      <form action="" className="form_main">
        ...
        <div className="inputContainer">
          <svg className="inputIcon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2a2a2a" viewBox="0 0 16 16">
        ...
        <button id="button" onClick={(e) => handleLogin(e)}>Submit</button>
      </form>
    </div>
  )
}
